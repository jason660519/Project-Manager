...
export type ViewId = 'dashboard' | 'features' | 'integrations-hub' | 'cmux' | 'xmux' | 'settings' | 'engineers' | 'channels' | 'sessions' | 'cron-jobs' | 'logs' | 'keys' | 'documentation' | 'company-standards' | 'chat' | 'keyboard-shortcuts';
