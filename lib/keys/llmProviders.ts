...
const PROVIDERS: LlmProviderSpec[] = [
  {
    ...
    developerDocsUrl: 'https://docs.anthropic.com/en/api/overview',
    apiKind: 'anthropic',
  ...
  },
  {
    ...
    developerDocsUrl: 'https://platform.openai.com/docs/api-reference/introduction',
  ...
  },
  {
    ...
    developerDocsUrl: 'https://ai.google.dev/gemini-api/docs',
    apiKind: 'gemini',
  ...
  },
  {
    ...
    developerDocsUrl: 'https://api-docs.deepseek.com/',
    apiKind: 'openai-compatible',
  ...
  },
  {
    ...
    docUrl: 'https://console.x.ai/team/default/api-keys',
    apiKeyUrl: 'https://console.x.ai/team/default/api-keys',
    usageUrl: 'https://console.x.ai/team/default/usage',
    developerDocsUrl: 'https://docs.x.ai/docs/overview',
    apiKind: 'openai-compatible',
  ...
  },
  {
    ...
    developerDocsUrl: 'https://platform.moonshot.ai/docs/overview',
    apiKind: 'openai-compatible',
  ...
  },
  {
    ...
    developerDocsUrl: 'https://openrouter.ai/docs/quickstart',
    apiKind: 'openai-compatible',
  ...
  },
  {
    ...
    usageUrl: 'https://console.perplexity.ai/group/34280378-ce16-4e12-a1ef-bc6bf8c5191a/billing',
    developerDocsUrl: 'https://docs.perplexity.ai/getting-started/quickstart',
    apiKind: 'openai-compatible',
  ...
  },
  {
    ...
    usageUrl: 'https://api.together.ai/settings/billing',
    developerDocsUrl: 'https://docs.together.ai/docs/quickstart',
    apiKind: 'openai-compatible',
  ...
  },
  {
    ...
    developerDocsUrl: 'https://docs.z.ai/api-reference/introduction',
    apiKind: 'openai-compatible',
  ...
  },
  {
    ...
    usageUrl: 'https://billing-cost.console.alibabacloud.com/fortune/fund-management/recharge',
    developerDocsUrl: 'https://help.aliyun.com/zh/model-studio/developer-reference/use-qwen-by-calling-api',
    apiKind: 'openai-compatible',
  ...
  },
  {
    ...
    developerDocsUrl: 'https://huggingface.co/docs/inference-providers/en/index',
    apiKind: 'openai-compatible',
  ...
  },
  {
    ...
    docUrl: 'https://docs.ollama.com/openai',
    apiKeyUrl: 'https://docs.ollama.com/openai',
    usageUrl: 'http://localhost:11434/api/tags',
    developerDocsUrl: 'https://docs.ollama.com/api',
    apiKind: 'openai-compatible',
  ...
  },
  {
    ...
    usageUrl: 'https://ollama.com/cloud',
    developerDocsUrl: 'https://docs.ollama.com/cloud',
    apiKind: 'openai-compatible',
