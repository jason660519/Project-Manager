...
| Sessions | `SessionsView` | `list_sessions`, `read_session`, `save_session` | Stored under project `.dev-pilot/sessions/`. |
...
| Sessions | `SessionsView` | `list_sessions`, `read_session`, `save_session` | 存在專案 `.dev-pilot/sessions/`。 |
